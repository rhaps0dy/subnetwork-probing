...
from visualize import (
    visualize_head_sparsity,
    visualize_dense_sparsity,
    visualize_layer_attn_sparsity,
)
...
for task in ["IOI"]:
    for setting in ("pretrained", "resetenc", "resetall"):
        for method in ["prune"]:  # , 'mlp1'):
            ...
            params_list = [
                (12, 1)
            ]  # 12 heads, but ablate ALL of the resid stream dims at once

            # ((768,768), (768,192), (768,24), (768,6),
            ...
            for params in params_list:
                ...
                print(
                    "Prune - (out,in)_w_per_mask: {}".format(
                        (out_w_per_mask, in_w_per_mask)
                    )
                )
                ...
                assert setting == "pretrained", setting
                ...
                if masked:
                    ...
                    print(
                        "Percentage of elements within 0.01 of 0 or 1: {:.5f}".format(
                            bert.compute_binary_pct()
                        )
                    )
